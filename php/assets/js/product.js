    document.addEventListener('DOMContentLoaded', function() {
        ...
        addToCartForms.forEach(form => {
            form.addEventListener('submit', async function(event) {
                ...
                if (productCard) {
                    const itemName = productCard.querySelector('.product-card h2');
                    const itemPrice = productCard.querySelector('.product-detail .wine-actions p');
                    const itemImage = productCard.querySelector('.product-detail .wine-actions img');
